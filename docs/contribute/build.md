...
```
!!! note "For users with docker <= 22, the BuildKit plugin must also be installed. You can also build with the legacy builder with `docker build --tag "rocknix/rocknix-build:latest" .`"  
