...
![](../../_inc/images/devices/anbernic-rg35xx2024.png){ .off-glb }
...
| -- | -- | -- | -- | -- |
| RG35XX 2024 | Allwinner H700 (ARM) | Mainline Linux | Panfrost | Sway + Emulation Station |
...
Important, before booting the device, edit the file `extlinux/extlinux.conf` and change the line `  FDT /sun50i-h700-anbernic-rg35xx-plus` to `  FDT /sun50i-h700-anbernic-rg35xx-2024.dtb`.

If the display doesn't seems to works (flickering, noise, etc...), you may have a version with a new display, in that case use `  FDT /sun50i-h700-anbernic-rg35xx-2024-rev6-panel.dtb`
