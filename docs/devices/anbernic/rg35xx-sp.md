...
!!! warning "Before booting the device, copy the file `/device_trees/sun50i-h700-anbernic-rg35xx-sp.dtb` to `/dtb.img`. If the display doesn't seems to works (flickering, noise, etc...), you may have a version with a new display, in that case, copy the file `/device_trees/sun50i-h700-anbernic-rg35xx-sp-rev6-panel.dtb`"
