...
![](../../_inc/images/devices/anbernic-rg40xxv.png){ .off-glb }
...
| -- | -- | -- | -- | -- |
| RG40XX V | Allwinner H700 (ARM) | Mainline Linux | Panfrost | Sway + Emulation Station |
...
`  FDT /sun50i-h700-anbernic-rg35xx-plus` to `  FDT /sun50i-h700-anbernic-rg40xx-v.dtb`."
