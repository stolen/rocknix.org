...
![](../../_inc/images/devices/anbernic-rgcubexx.png){ .off-glb }
...
| -- | -- | -- | -- | -- |
| RG CubeXX | Allwinner H700 (ARM) | Mainline Linux | Panfrost | Sway + Emulation Station |
...
!!! warning "Before booting the device, edit the file `extlinux/extlinux.conf` and change the line
`  FDT /sun50i-h700-anbernic-rg35xx-plus` to `  FDT /sun50i-h700-anbernic-rgcubexx.dtb`."
