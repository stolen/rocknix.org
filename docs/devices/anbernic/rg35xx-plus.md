...
!!! warning "Before booting the device, copy the file `/device_trees/sun50i-h700-anbernic-rg35xx-plus.dtb` to `/dtb.img`. If the display doesn't seems to works (flickering, noise, etc...), you may have a version with a new display, in that case, copy the file `/device_trees/sun50i-h700-anbernic-rg35xx-plus-rev6-panel.dtb`"
